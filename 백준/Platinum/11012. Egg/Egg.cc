...
void solve(ll tc){
    ...
    ll ans = 0;
    while (m--) {
        ll l, r, b, t; cin>>l>>r>>b>>t;
        ll L = lower_bound(arr.begin(), arr.end(), pll{l, -INF}) - arr.begin();
        ll R = upper_bound(arr.begin(), arr.end(), pll{r, INF}) - arr.begin();
        ans += pst.query(R, b, t) - pst.query(L, b, t);
    }
    cout<<ans<<endl;
}
