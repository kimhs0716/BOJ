# [Gold III] Hop — Don’t Walk! - 4893 

[문제 링크](https://www.acmicpc.net/problem/4893) 
...
<p>Where k is the test case number (starting at one,) and M is the minimum number of moves needed to transform the given arrangement to an arrangement that has no white tile(s) between any of its black tiles . The frog can be anywhere. M is -1 if the problem cannot be solved in less than 10 moves.</p>
