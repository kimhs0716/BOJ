...
### 입력 
 ...
 <p>첫 번째 줄에 건희가 제시한 길이 $N(1\le N\le 10^6)$의 알파벳 소문자로만 이루어진 문자열이 주어진다.</p>
